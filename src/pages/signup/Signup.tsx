        ...
        <div className="flex min-h-screen items-center justify-center bg-white">
            <div className="w-full max-w-md p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <Input type="text" name="name" placeholder="Enter your username" value={form.name}
                           onChange={handleChange} variant="outlined"/>
                    <Input type="email" name="email" placeholder="Enter your email" value={form.email}
                           onChange={handleChange} variant="outlined"/>
                    <Input type="text" name="nickname" placeholder="Enter your nickname" value={form.nickname}
                           onChange={handleChange} variant="outlined"/>
                    {emailError && (
